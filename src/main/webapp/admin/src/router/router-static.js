...
import center from '@/views/center'
    ...
    import caipinLiuyan from '@/views/modules/caipinLiuyan/list'
    ...
    import dictionaryWenzhangYesno from '@/views/modules/dictionaryWenzhangYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryWenzhangYesno',
        name: '审核状态',
        component: dictionaryWenzhangYesno
    }
    ,{
        path: '/config',
        name: '轮播图',

    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="caipinLiuyanText">
                        <el-input type="textarea"  :readonly="ro.caipinLiuyanText" v-model="ruleForm.caipinLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.caipinLiuyanText" label="留言内容" prop="caipinLiuyanText">
                            <span v-html="ruleForm.caipinLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.caipinId = true;//餐厅菜品
                this.ro.yonghuId = true;//用户
                this.ro.caipinLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`caipinLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.caipinLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();

        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价格" prop="caipinMoney">
                       <el-input v-model="ruleForm.caipinMoney"
                                 placeholder="价格" clearable  :readonly="ro.caipinMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="菜品详情" prop="caipinContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.caipinContent" label="菜品详情" prop="caipinContent">

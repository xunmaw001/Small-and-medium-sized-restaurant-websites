        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='caipin'">
                    <el-form-item class="select" v-if="type!='info'"  label="餐厅菜品" prop="caipinId">
                        <el-select v-model="ruleForm.caipinId" :disabled="ro.caipinId" filterable placeholder="请选择餐厅菜品" @change="caipinChange">
                            <el-option
                ...
                <el-col :span="12" v-if="sessionTable !='caipin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.caipinPhoto" label="菜品图片" prop="caipinPhoto">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.caipinPhoto" label="菜品图片" prop="caipinPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="价格" prop="caipinMoney">
                        <el-input v-model="caipinForm.caipinMoney"
                                  placeholder="价格" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="价格" prop="caipinMoney">
                            <el-input v-model="ruleForm.caipinMoney"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wenzhangYesnoTypes" label="审核状态" prop="wenzhangYesnoTypes">
                        <el-input v-model="ruleForm.wenzhangYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wenzhangYesnoText" label="审核结果" prop="wenzhangYesnoText">
                        <span v-html="ruleForm.wenzhangYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    wenzhangYesnoTypes: false,
                    wenzhangYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    caipinId: '',
                ...
                wenzhangYesnoTypesOptions : [],
                caipinOptions : [],
                yonghuOptions : [],
                rules: {
                   caipinId: [
                              { required: true, message: '餐厅菜品不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wenzhang_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wenzhangYesnoTypesOptions = data.data.list;
                    }
                });

...
public class WenzhangView extends WenzhangEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 审核状态的值
		*/
		private String wenzhangYesnoValue;
	...
	public WenzhangView(WenzhangEntity wenzhangEntity) {
		try {
			...
			* 获取： 审核状态的值
			*/
			public String getWenzhangYesnoValue() {
				return wenzhangYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setWenzhangYesnoValue(String wenzhangYesnoValue) {
				this.wenzhangYesnoValue = wenzhangYesnoValue;
			}
